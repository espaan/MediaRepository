{* purpose of this template: media handlers view view in admin area *}
...
{checkpermissionblock component='MediaRepository:MediaHandler:' instance='.*' level='ACCESS_ADD'}
    ...
    <a href="{modurl modname='MediaRepository' type='admin' func='edit' ot='mediaHandler'}" title="{$createTitle}" class="z-icon-es-add">
        {$createTitle}
    </a>
...
{if isset($showAllEntries) && $showAllEntries eq 1}
    ...
    <a href="{modurl modname='MediaRepository' type='admin' func='view' ot='mediaHandler'}" title="{$linkTitle}" class="z-icon-es-view">
        {$linkTitle}
    </a>
    {assign var='all' value=1}
{else}
    {gt text='Show all entries' assign='linkTitle'}
    <a href="{modurl modname='MediaRepository' type='admin' func='view' ot='mediaHandler' all=1}" title="{$linkTitle}" class="z-icon-es-view">
        {$linkTitle}
    </a>
{/if}

{include file='admin/mediaHandler/view_quickNav.tpl'}{* see template file for available options *}
...
<table class="z-datatable">
    ...
    <tr>
        <th id="hmimetype" scope="col" class="z-left">
            {sortlink __linktext='Mime type' sort='mimeType' currentsort=$sort sortdir=$sdir all=$all own=$own Medium=$Medium searchterm=$searchterm pageSize=$pageSize active=$active modname='MediaRepository' type='admin' func='view' ot='mediaHandler'}
        </th>
        <th id="hfiletype" scope="col" class="z-left">
            {sortlink __linktext='File type' sort='fileType' currentsort=$sort sortdir=$sdir all=$all own=$own Medium=$Medium searchterm=$searchterm pageSize=$pageSize active=$active modname='MediaRepository' type='admin' func='view' ot='mediaHandler'}
        </th>
        <th id="hfoundmimetype" scope="col" class="z-left">
            {sortlink __linktext='Found mime type' sort='foundMimeType' currentsort=$sort sortdir=$sdir all=$all own=$own Medium=$Medium searchterm=$searchterm pageSize=$pageSize active=$active modname='MediaRepository' type='admin' func='view' ot='mediaHandler'}
        </th>
        <th id="hfoundfiletype" scope="col" class="z-left">
            {sortlink __linktext='Found file type' sort='foundFileType' currentsort=$sort sortdir=$sdir all=$all own=$own Medium=$Medium searchterm=$searchterm pageSize=$pageSize active=$active modname='MediaRepository' type='admin' func='view' ot='mediaHandler'}
        </th>
        <th id="hhandlername" scope="col" class="z-left">
            {sortlink __linktext='Handler name' sort='handlerName' currentsort=$sort sortdir=$sdir all=$all own=$own Medium=$Medium searchterm=$searchterm pageSize=$pageSize active=$active modname='MediaRepository' type='admin' func='view' ot='mediaHandler'}
        </th>
        <th id="htitle" scope="col" class="z-left">
            {sortlink __linktext='Title' sort='title' currentsort=$sort sortdir=$sdir all=$all own=$own Medium=$Medium searchterm=$searchterm pageSize=$pageSize active=$active modname='MediaRepository' type='admin' func='view' ot='mediaHandler'}
        </th>
        <th id="hactive" scope="col" class="z-center">
            {sortlink __linktext='Active' sort='active' currentsort=$sort sortdir=$sdir all=$all own=$own Medium=$Medium searchterm=$searchterm pageSize=$pageSize active=$active modname='MediaRepository' type='admin' func='view' ot='mediaHandler'}
        </th>
        <th id="himage" scope="col" class="z-left">
            {sortlink __linktext='Image' sort='image' currentsort=$sort sortdir=$sdir all=$all own=$own Medium=$Medium searchterm=$searchterm pageSize=$pageSize active=$active modname='MediaRepository' type='admin' func='view' ot='mediaHandler'}
        </th>

{* purpose of this template: media handlers display view in admin area *}
...
<div class="z-admin-content-pagetitle">
    ...
    <h3>{$templateTitle|notifyfilters:'mediarepository.filter_hooks.mediahandlers.filter'}{icon id='itemactionstrigger' type='options' size='extrasmall' __alt='Actions' style='display: none' class='z-pointer'}</h3>
</div>
...
{include file='admin/include_standardfields_display.tpl' obj=$mediaHandler}

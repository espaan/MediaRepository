...
/**
 * The mediarepositoryFormFrame plugin adds styling <div> elements and a validation summary.
 *
 ...
 */
function smarty_block_mediarepositoryFormFrame($params, $content, $view)
{
    ...
    $result .= $view->registerBlock('MediaRepository_Form_Plugin_FormFrame', $params, $content);

...
/**
 * The mediarepositoryTemplateHeaders plugin performs header() operations
 ...
 */
function smarty_function_mediarepositoryTemplateHeaders($params, $view)
{
    if (!isset($params['contentType'])) {
        $view->trigger_error($view->__f('%1$s: missing parameter \'%2$s\'', array('smarty_function_mediarepositoryTemplateHeaders', 'contentType')));
    }

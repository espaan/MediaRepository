...
{form cssClass='z-form'}
    ...
    <div class="z-panels" id="MediaRepository_panel">
        ...
        {include file='user/include_categories_edit.tpl' obj=$repository groupName='repositoryObj' panel=true}
        {if $mode ne 'create'}
            {include file='user/include_standardfields_edit.tpl' obj=$repository panel=true}
        {/if}
        {include file='user/thumbSize/include_selectEditMany.tpl' relItem=$repository aliasName='thumbSizes' idPrefix='medrepRepository_ThumbSizes' panel=true}

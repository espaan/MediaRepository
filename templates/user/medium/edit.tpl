...
{form enctype='multipart/form-data' cssClass='z-form'}
    ...
    <div class="z-panels" id="MediaRepository_panel">
        ...
        <div class="z-panel-content z-panel-active" style="overflow: visible">
            <fieldset>
                ...
                <div class="z-formrow">
                    ...
                    {formtextinput group='medium' id='dateTaken' mandatory=false readOnly=false __title='Enter the date taken of the medium' textMode='singleline' maxLength=255 cssClass='' }
                </div>
        ...
        {include file='user/include_attributes_edit.tpl' obj=$medium panel=true}
        {include file='user/include_categories_edit.tpl' obj=$medium groupName='mediumObj' panel=true}
        {if $mode ne 'create'}
            {include file='user/include_standardfields_edit.tpl' obj=$medium panel=true}
        {/if}
        {include file='user/include_metadata_edit.tpl' obj=$medium panel=true}

...
class MediaRepository_Block_Base_ItemList extends Zikula_Controller_AbstractBlock
{
    ...
    public function display($blockinfo)
    {
        ...
        if (!isset($vars['objectType']) || !in_array($vars['objectType'], MediaRepository_Util_Controller::getObjectTypes('block', $utilArgs))) {
            $vars['objectType'] = MediaRepository_Util_Controller::getDefaultObjectType('block', $utilArgs);
        }
    ...
    public function update($blockinfo)
    {
        ...
        if (!in_array($vars['objectType'], MediaRepository_Util_Controller::getObjectTypes('block'))) {
            $vars['objectType'] = MediaRepository_Util_Controller::getDefaultObjectType('block');
        }

 ...
 */
class MediaRepository_ContentType_Base_ItemList extends Content_AbstractContentType
{
    ...
    public function getTitle()
    {
        ...
        return __('MediaRepository list view', $dom);
    }
    ...
    {
        $dom = ZLanguage::getModuleDomain('MediaRepository');
        return __('Display list of MediaRepository objects.', $dom);
    }
    ...
    public function display()
    {
        ...
        $repository = $entityManager->getRepository('MediaRepository_Entity_' . ucfirst($this->objectType));
    ...
    protected function getSortParam($repository)
    {
        ...
        if ($this->sorting == 'newest') {
            $idFields = ModUtil::apiFunc('MediaRepository', 'selection', 'getIdFields', array('ot' => $this->objectType));
            if (count($idFields) == 1) {

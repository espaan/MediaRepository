...
class MediaRepository_Entity_Medium extends MediaRepository_Entity_Base_Medium {
    ...
    public function postLoadCallback() {
        ...
        //now I need to set the storage folder (and maybe other folders) to the correct directories
        if ($rep != null) {
            //I need to figure this out
            //I can't do this becaue it gets recursive. There must be a way of finding this.
            //$rep = 
        }
    }

 ...
 */
class MediaRepository_Form_Handler_Admin_ThumbSize_Base_Edit extends MediaRepository_Form_Handler_Admin_Edit
{
    /**
    ...
    protected function getDefaultReturnUrl($args)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            ...
            $url = ModUtil::url($this->name, 'admin', 'display', array('ot' => 'thumbSize', 'id' => $this->idValues['id']));
        }
        return $url;
    }

 ...
 */
class MediaRepository_Form_Handler_Admin_Base_Config extends Zikula_Form_AbstractHandler
{
    /**
    ...
    {
        // permission check
        if (!SecurityUtil::checkPermission('MediaRepository::', '::', ACCESS_ADMIN)) {
            return $view->registerError(LogUtil::registerPermissionError());
        }

        // retrieve module vars
        $modVars = ModUtil::getVar('MediaRepository');
    ...
    public function handleCommand(Zikula_Form_View $view, &$args)
    {
        if ($args['commandName'] == 'save') {
            ...
            if (!ModUtil::setVars('MediaRepository', $data['config'])) {
        ...
        $url = ModUtil::url('MediaRepository', 'admin', 'config');

 ...
 */
class MediaRepository_Form_Handler_Admin_Base_Edit extends Zikula_Form_AbstractHandler
{
    /**
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        $this->idValues = MediaRepository_Util_Controller::retrieveIdentifier($this->request, array(), $this->objectType, $this->idFields);
        $hasIdentifier = MediaRepository_Util_Controller::isValidIdentifier($this->idValues);
    ...
    public function handleCommand(Zikula_Form_View $view, &$args)
    {
        ...
        $hookAreaPrefix = 'mediarepository.ui_hooks.' . $this->objectTypeLowerMultiple;
    ...
    protected function processMetaDataForUpdate($entity, $entityData)
    {
        ...
        if (is_null($metaData)) {
           $metaDataEntityClass = 'MediaRepository_Entity_' . ucfirst($this->objectType) . 'MetaData';

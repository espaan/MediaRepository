 ...
 */
class MediaRepository_Form_Handler_User_MediaHandler_Base_Edit extends MediaRepository_Form_Handler_User_Edit
{
    /**
    ...
    protected function getDefaultReturnUrl($args)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            ...
            $url = ModUtil::url($this->name, 'user', 'display', array('ot' => 'mediaHandler', 'id' => $this->idValues['id']));
        }
        return $url;
    }

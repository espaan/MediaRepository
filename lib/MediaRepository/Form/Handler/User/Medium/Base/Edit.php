 ...
 */
class MediaRepository_Form_Handler_User_Medium_Base_Edit extends MediaRepository_Form_Handler_User_Edit
{
    /**
    ...
    protected function getDefaultReturnUrl($args)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            ...
            $url = ModUtil::url($this->name, 'user', 'display', array('ot' => 'medium', 'id' => $this->idValues['id'], 'slug' => $this->idValues['slug']));
        }
        return $url;
    }

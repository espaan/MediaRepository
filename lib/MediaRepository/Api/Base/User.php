 ...
 */
class MediaRepository_Api_Base_User extends Zikula_AbstractApi
{
    /**
    ...
    public function getlinks()
    {
        ...
        if (SecurityUtil::checkPermission($this->name . ':Repository:', '::', ACCESS_READ)) {
            $links[] = array('url' => ModUtil::url($this->name, 'user', 'view', array('ot' => 'repository')),
                             'text' => $this->__('Repositories'),
                             'title' => $this->__('Repository list'));
        }
        if (SecurityUtil::checkPermission($this->name . ':MediaHandler:', '::', ACCESS_READ)) {
            $links[] = array('url' => ModUtil::url($this->name, 'user', 'view', array('ot' => 'mediaHandler')),
        ...
        if (SecurityUtil::checkPermission($this->name . ':ThumbSize:', '::', ACCESS_READ)) {
            $links[] = array('url' => ModUtil::url($this->name, 'user', 'view', array('ot' => 'thumbSize')),
    ...
    public function encodeurl($args)
    {
        ...
        $routerFacade = new MediaRepository_RouterFacade();
        ...
        $allowedObjectTypes = MediaRepository_Util_Controller::getObjectTypes('api', $utilArgs);
        $objectType = ((isset($args['args']['ot']) && in_array($args['args']['ot'], $allowedObjectTypes)) ? $args['args']['ot'] : MediaRepository_Util_Controller::getDefaultObjectType('api', $utilArgs));
        ...
        $modInfo = ModUtil::getInfoFromName('MediaRepository');

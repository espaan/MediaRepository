 ...
 */
class MediaRepository_Api_Base_Cache extends Zikula_AbstractApi
{
    /**
    ...
    public function clearItemCache($args)
    {
        ...
        $view = Zikula_View::getInstance('MediaRepository');
        ...
        $cacheIds[] = 'MediaRepository/user/main'; // main function
        $cacheIds[] = 'MediaRepository/user/view/' . $objectType; // view function (list views)
        $cacheIds[] = 'MediaRepository/user/display/' . $objectType . '|' . $instanceId; // display function (detail views)

 ...
 */
class MediaRepository_Controller_Base_Admin extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function view($args)
    {
        ...
        $templateFile = MediaRepository_Util_View::getViewTemplate($this->view, 'admin', $objectType, 'view', $args);
        ...
        if ($showAllEntries == 1) {
            ...
            if ($this->view->is_cached($templateFile)) {
                return MediaRepository_Util_View::processTemplate($this->view, 'admin', $objectType, 'view', $args, $templateFile);
            }
    ...
    public function display($args)
    {
        ...
        $templateFile = MediaRepository_Util_View::getViewTemplate($this->view, 'admin', $objectType, 'display', $args);
        ...
        // fetch and return the appropriate template
        return MediaRepository_Util_View::processTemplate($this->view, 'admin', $objectType, 'display', $args, $templateFile);
    }
    ...
    public function config()
    {
        ...
        // Execute form using supplied template and page event handler
        return $view->execute('admin/config.tpl', new MediaRepository_Form_Handler_Admin_Config());
    }
}
